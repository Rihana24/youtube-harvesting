...
icon = Image.open(r"C:/Users/pc\Desktop/youtube_harvesting/Phonepe/pulse/data/logo.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Rihana",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard is created by *Rihana*!
                                        Data is cloned from Phonepe Pulse Github Repo"""})

st.sidebar.header(":wave: :violet[**Hi! Welcome to the dashboard**]")

# #To clone the Github Pulse repository used the below code
...
# To create option menu in the side bar
with st.sidebar:
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"C:/Users/pc/Desktop/youtube_harvesting/Phonepe/pulse/data/Statenames.csv")
            df1.State = df2
